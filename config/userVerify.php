...
class UserVerify
{
    ...
    public function userLength($username)
    { //Verifica se o usuario tem mais de 8 caracteres
        $verified = strlen($username) >= 5 ? $username : false;
        return $verified;
    }
    public function userAvailable($username)
    { //Verifica se o usuario ja foi cadastrado no banco de dados
    ...
    { //verifica se a senha contém letra maiscula e caracteres especiais
